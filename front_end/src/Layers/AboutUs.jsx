...
const services = [
  {
    ...
    description:
      "Thorough assessment of all medications to ensure optimal therapy and prevent adverse interactions.",
  },
  {
    icon: <Stethoscope className="w-8 h-8" />,
    title: "Pharmacotherapy Consultations",
    description:
      "Expert guidance on medication management and treatment optimization.",
  },
  {
    icon: <Heart className="w-8 h-8" />,
    title: "Patient Education",
    description:
      "Comprehensive support and education to help patients understand their medications.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl  text-[var(--0ne)] ">
            ...
            healthcare providers. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Modi laudantium dicta explicabo velit aspernatur
            officiis soluta consequatur repellendus necessitatibus ullam ipsam
        ...
        >
          ...
          <p className="text-gray-900 leading-relaxed">
            Our mission is to optimize medication management, ensuring safety
            and improving therapeutic outcomes for every patient. We believe in
            a collaborative approach to healthcare that puts patients first.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl font text-[var(--six)] mb-2">
                {service.title}
              </h3>
